...
================
Compiled at 2023-11-09 10:48:55 UTC
...
- if the max rel. count of all samples is at least 0.01 OR
- if mean rel. count over all samples is higher than 0.001 (in detail:
  samples with mean count \<= 0.001 are removed) AND
- if there are not more than 80% of the samples equal to zero (in
  detail: 20% of samples have a relative count \> 10^{-5})
...
![](02-filter_and_group_ts_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](02-filter_and_group_ts_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](02-filter_and_group_ts_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
```
    ...
    ## 1 ts_Ushio_PhylumLevel_most_abundant.csv file        4.74K 2023-11-09 10:49:06
