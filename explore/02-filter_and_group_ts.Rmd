...
Check for every taxon:
  ...
  * if mean rel. count over all samples is higher than 0.0001 
  (in detail: samples with mean count <= 1e-4 are removed) OR
...
Check further for every taxon:
  ...
  * if there are not more than 85% of the samples equal to zero 
  (in detail: 15% of samples have a relative count > 1e-5) OR
