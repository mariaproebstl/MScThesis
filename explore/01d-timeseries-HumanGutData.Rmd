---
title: "01d-timeseries-HumanGutData"
date: "Compiled at `r format(Sys.time(), '%Y-%m-%d %H:%M:%S', tz = 'UTC')` UTC"
output: github_document
params:
  name: "01d-timeseries-HumanGutData" # change if you rename file
---
...
from the Gibbons data and transform the time series to a phyloseq object.
